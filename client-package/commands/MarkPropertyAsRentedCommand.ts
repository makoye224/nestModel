...
import {
  de_MarkPropertyAsRentedCommand,
  se_MarkPropertyAsRentedCommand,
 ...
 * @public
 *
 * The input for {@link MarkPropertyAsRentedCommand}.
 */
export interface MarkPropertyAsRentedCommandInput extends MarkPropertyAsRentedRequest {}
/**
 * @public
 *
 * The output of {@link MarkPropertyAsRentedCommand}.
 */
export interface MarkPropertyAsRentedCommandOutput extends MarkPropertyAsRentedResponse, __MetadataBearer {}
 ...
 * ```javascript
 * import { RentalPlatformClient, MarkPropertyAsRentedCommand } from "@com.nest/nest-service-client"; // ES Modules import
 * // const { RentalPlatformClient, MarkPropertyAsRentedCommand } = require("@com.nest/nest-service-client"); // CommonJS import
 * const client = new RentalPlatformClient(config);
 * const input = { // MarkPropertyAsRentedRequest
 *   propertyId: "STRING_VALUE", // required
 * };
 * const command = new MarkPropertyAsRentedCommand(input);
 ...
 * ```
 *
 * @param MarkPropertyAsRentedCommandInput - {@link MarkPropertyAsRentedCommandInput}
 * @returns {@link MarkPropertyAsRentedCommandOutput}
 * @see {@link MarkPropertyAsRentedCommandInput} for command's `input` shape.
 * @see {@link MarkPropertyAsRentedCommandOutput} for command's `response` shape.
 ...
 * @public
 */
export class MarkPropertyAsRentedCommand extends $Command.classBuilder<MarkPropertyAsRentedCommandInput, MarkPropertyAsRentedCommandOutput, RentalPlatformClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  ...
  .s("RentalPlatform", "MarkPropertyAsRented", {

  })
  .n("RentalPlatformClient", "MarkPropertyAsRentedCommand")
  .f(void 0, void 0)
  .ser(se_MarkPropertyAsRentedCommand)
  .de(de_MarkPropertyAsRentedCommand)
.build() {
}
