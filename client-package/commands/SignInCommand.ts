 ...
 * ```javascript
 * import { RentalPlatformClient, SignInCommand } from "@com.nest/nest-service-client"; // ES Modules import
 * // const { RentalPlatformClient, SignInCommand } = require("@com.nest/nest-service-client"); // CommonJS import
 ...
 * @public
 */
export class SignInCommand extends $Command.classBuilder<SignInCommandInput, SignInCommandOutput, RentalPlatformClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  ...
  .s("RentalPlatform", "SignIn", {

  })
  .n("RentalPlatformClient", "SignInCommand")
  .f(void 0, void 0)
