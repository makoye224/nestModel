...
exports.AssignPropertyManagerHandler = exports.getAssignPropertyManagerHandler = exports.AssignPropertyManagerSerializer = exports.AssignPropertyManagerServerInput = void 0;
...
var AssignPropertyManagerServerInput;
(function (AssignPropertyManagerServerInput) {
    /**
     * @internal
     */
    AssignPropertyManagerServerInput.validate = models_0_1.AssignPropertyManagerRequest.validate;
})(AssignPropertyManagerServerInput || (exports.AssignPropertyManagerServerInput = AssignPropertyManagerServerInput = {}));
class AssignPropertyManagerSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeAssignPropertyManagerResponse;
        this.deserialize = Aws_restJson1_1.deserializeAssignPropertyManagerRequest;
    }
    isOperationError(error) {
        const names = ["ValidationException", "PropertyNotFoundException", "UnauthorizedException", "RentalValidationException", "InternalServerError"];
...
exports.AssignPropertyManagerSerializer = AssignPropertyManagerSerializer;
const getAssignPropertyManagerHandler = (operation) => {
    ...
    return new AssignPropertyManagerHandler(operation, mux, new AssignPropertyManagerSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getAssignPropertyManagerHandler = getAssignPropertyManagerHandler;
...
class AssignPropertyManagerHandler {
    /**
...
exports.AssignPropertyManagerHandler = AssignPropertyManagerHandler;
