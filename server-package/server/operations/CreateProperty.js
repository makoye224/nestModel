...
exports.CreatePropertyHandler = exports.getCreatePropertyHandler = exports.CreatePropertySerializer = exports.CreatePropertyServerInput = void 0;
...
var CreatePropertyServerInput;
(function (CreatePropertyServerInput) {
    /**
     * @internal
     */
    CreatePropertyServerInput.validate = models_0_1.CreatePropertyRequest.validate;
})(CreatePropertyServerInput || (exports.CreatePropertyServerInput = CreatePropertyServerInput = {}));
class CreatePropertySerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeCreatePropertyResponse;
        this.deserialize = Aws_restJson1_1.deserializeCreatePropertyRequest;
    }
...
exports.CreatePropertySerializer = CreatePropertySerializer;
const getCreatePropertyHandler = (operation) => {
    ...
    return new CreatePropertyHandler(operation, mux, new CreatePropertySerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getCreatePropertyHandler = getCreatePropertyHandler;
