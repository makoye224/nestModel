...
exports.DeletePropertyHandler = exports.getDeletePropertyHandler = exports.DeletePropertySerializer = exports.DeletePropertyServerInput = void 0;
...
var DeletePropertyServerInput;
(function (DeletePropertyServerInput) {
    /**
     * @internal
     */
    DeletePropertyServerInput.validate = models_0_1.DeletePropertyRequest.validate;
})(DeletePropertyServerInput || (exports.DeletePropertyServerInput = DeletePropertyServerInput = {}));
class DeletePropertySerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeDeletePropertyResponse;
        this.deserialize = Aws_restJson1_1.deserializeDeletePropertyRequest;
    }
    isOperationError(error) {
        const names = ["ValidationException", "PropertyNotFoundException", "UnauthorizedException", "InternalServerError", "RentalValidationException"];
...
exports.DeletePropertySerializer = DeletePropertySerializer;
const getDeletePropertyHandler = (operation) => {
    ...
    return new DeletePropertyHandler(operation, mux, new DeletePropertySerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getDeletePropertyHandler = getDeletePropertyHandler;
