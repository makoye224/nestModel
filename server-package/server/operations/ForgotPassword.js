...
exports.ForgotPasswordHandler = exports.getForgotPasswordHandler = exports.ForgotPasswordSerializer = exports.ForgotPasswordServerInput = void 0;
...
var ForgotPasswordServerInput;
(function (ForgotPasswordServerInput) {
    /**
     * @internal
     */
    ForgotPasswordServerInput.validate = models_0_1.ForgotPasswordInput.validate;
})(ForgotPasswordServerInput || (exports.ForgotPasswordServerInput = ForgotPasswordServerInput = {}));
class ForgotPasswordSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeForgotPasswordResponse;
        this.deserialize = Aws_restJson1_1.deserializeForgotPasswordRequest;
    }
...
exports.ForgotPasswordSerializer = ForgotPasswordSerializer;
const getForgotPasswordHandler = (operation) => {
    ...
    return new ForgotPasswordHandler(operation, mux, new ForgotPasswordSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
