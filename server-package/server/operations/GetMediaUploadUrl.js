...
exports.GetMediaUploadUrlHandler = exports.getGetMediaUploadUrlHandler = exports.GetMediaUploadUrlSerializer = exports.GetMediaUploadUrlServerInput = void 0;
...
var GetMediaUploadUrlServerInput;
(function (GetMediaUploadUrlServerInput) {
    /**
     * @internal
     */
    GetMediaUploadUrlServerInput.validate = models_0_1.GetMediaUploadUrlRequest.validate;
})(GetMediaUploadUrlServerInput || (exports.GetMediaUploadUrlServerInput = GetMediaUploadUrlServerInput = {}));
class GetMediaUploadUrlSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeGetMediaUploadUrlResponse;
        this.deserialize = Aws_restJson1_1.deserializeGetMediaUploadUrlRequest;
    }
...
exports.GetMediaUploadUrlSerializer = GetMediaUploadUrlSerializer;
const getGetMediaUploadUrlHandler = (operation) => {
    ...
    return new GetMediaUploadUrlHandler(operation, mux, new GetMediaUploadUrlSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getGetMediaUploadUrlHandler = getGetMediaUploadUrlHandler;
...
class GetMediaUploadUrlHandler {
    /**
...
exports.GetMediaUploadUrlHandler = GetMediaUploadUrlHandler;
