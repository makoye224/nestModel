...
exports.GetNearbyPropertiesHandler = exports.getGetNearbyPropertiesHandler = exports.GetNearbyPropertiesSerializer = exports.GetNearbyPropertiesServerInput = void 0;
...
var GetNearbyPropertiesServerInput;
(function (GetNearbyPropertiesServerInput) {
    /**
     * @internal
     */
    GetNearbyPropertiesServerInput.validate = models_0_1.GetNearbyPropertiesRequest.validate;
})(GetNearbyPropertiesServerInput || (exports.GetNearbyPropertiesServerInput = GetNearbyPropertiesServerInput = {}));
class GetNearbyPropertiesSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeGetNearbyPropertiesResponse;
        this.deserialize = Aws_restJson1_1.deserializeGetNearbyPropertiesRequest;
    }
...
exports.GetNearbyPropertiesSerializer = GetNearbyPropertiesSerializer;
const getGetNearbyPropertiesHandler = (operation) => {
    ...
    return new GetNearbyPropertiesHandler(operation, mux, new GetNearbyPropertiesSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getGetNearbyPropertiesHandler = getGetNearbyPropertiesHandler;
...
exports.GetNearbyPropertiesHandler = GetNearbyPropertiesHandler;
