...
exports.GetPropertiesByLocationHandler = exports.getGetPropertiesByLocationHandler = exports.GetPropertiesByLocationSerializer = exports.GetPropertiesByLocationServerInput = void 0;
...
var GetPropertiesByLocationServerInput;
(function (GetPropertiesByLocationServerInput) {
    /**
     * @internal
     */
    GetPropertiesByLocationServerInput.validate = models_0_1.GetPropertiesByLocationRequest.validate;
})(GetPropertiesByLocationServerInput || (exports.GetPropertiesByLocationServerInput = GetPropertiesByLocationServerInput = {}));
class GetPropertiesByLocationSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeGetPropertiesByLocationResponse;
        this.deserialize = Aws_restJson1_1.deserializeGetPropertiesByLocationRequest;
    }
...
exports.GetPropertiesByLocationSerializer = GetPropertiesByLocationSerializer;
const getGetPropertiesByLocationHandler = (operation) => {
    ...
    return new GetPropertiesByLocationHandler(operation, mux, new GetPropertiesByLocationSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getGetPropertiesByLocationHandler = getGetPropertiesByLocationHandler;
...
class GetPropertiesByLocationHandler {
    /**
...
exports.GetPropertiesByLocationHandler = GetPropertiesByLocationHandler;
