...
exports.GetPropertyHandler = exports.getGetPropertyHandler = exports.GetPropertySerializer = exports.GetPropertyServerInput = void 0;
...
var GetPropertyServerInput;
(function (GetPropertyServerInput) {
    /**
     * @internal
     */
    GetPropertyServerInput.validate = models_0_1.GetPropertyRequest.validate;
})(GetPropertyServerInput || (exports.GetPropertyServerInput = GetPropertyServerInput = {}));
class GetPropertySerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeGetPropertyResponse;
        this.deserialize = Aws_restJson1_1.deserializeGetPropertyRequest;
    }
    isOperationError(error) {
        const names = ["ValidationException", "RentalValidationException", "PropertyNotFoundException", "InternalServerError", "UnauthorizedException"];
...
const getGetPropertyHandler = (operation) => {
    ...
    return new GetPropertyHandler(operation, mux, new GetPropertySerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getGetPropertyHandler = getGetPropertyHandler;
