...
exports.ListLandlordPropertiesHandler = exports.getListLandlordPropertiesHandler = exports.ListLandlordPropertiesSerializer = exports.ListLandlordPropertiesServerInput = void 0;
...
var ListLandlordPropertiesServerInput;
(function (ListLandlordPropertiesServerInput) {
    /**
     * @internal
     */
    ListLandlordPropertiesServerInput.validate = models_0_1.ListLandlordPropertiesRequest.validate;
})(ListLandlordPropertiesServerInput || (exports.ListLandlordPropertiesServerInput = ListLandlordPropertiesServerInput = {}));
class ListLandlordPropertiesSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeListLandlordPropertiesResponse;
        this.deserialize = Aws_restJson1_1.deserializeListLandlordPropertiesRequest;
    }
    isOperationError(error) {
        const names = ["ValidationException", "RentalValidationException", "UnauthorizedException", "InternalServerError"];
...
exports.ListLandlordPropertiesSerializer = ListLandlordPropertiesSerializer;
const getListLandlordPropertiesHandler = (operation) => {
    ...
    return new ListLandlordPropertiesHandler(operation, mux, new ListLandlordPropertiesSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getListLandlordPropertiesHandler = getListLandlordPropertiesHandler;
...
class ListLandlordPropertiesHandler {
    /**
...
exports.ListLandlordPropertiesHandler = ListLandlordPropertiesHandler;
