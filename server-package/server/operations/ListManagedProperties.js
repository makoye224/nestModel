...
exports.ListManagedPropertiesHandler = exports.getListManagedPropertiesHandler = exports.ListManagedPropertiesSerializer = exports.ListManagedPropertiesServerInput = void 0;
...
var ListManagedPropertiesServerInput;
(function (ListManagedPropertiesServerInput) {
    /**
     * @internal
     */
    ListManagedPropertiesServerInput.validate = models_0_1.ListManagedPropertiesRequest.validate;
})(ListManagedPropertiesServerInput || (exports.ListManagedPropertiesServerInput = ListManagedPropertiesServerInput = {}));
class ListManagedPropertiesSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeListManagedPropertiesResponse;
        this.deserialize = Aws_restJson1_1.deserializeListManagedPropertiesRequest;
    }
...
exports.ListManagedPropertiesSerializer = ListManagedPropertiesSerializer;
const getListManagedPropertiesHandler = (operation) => {
    ...
    return new ListManagedPropertiesHandler(operation, mux, new ListManagedPropertiesSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getListManagedPropertiesHandler = getListManagedPropertiesHandler;
...
class ListManagedPropertiesHandler {
    /**
...
exports.ListManagedPropertiesHandler = ListManagedPropertiesHandler;
