...
exports.ListPropertiesHandler = exports.getListPropertiesHandler = exports.ListPropertiesSerializer = exports.ListPropertiesServerInput = void 0;
...
var ListPropertiesServerInput;
(function (ListPropertiesServerInput) {
    /**
     * @internal
     */
    ListPropertiesServerInput.validate = models_0_1.ListPropertiesRequest.validate;
})(ListPropertiesServerInput || (exports.ListPropertiesServerInput = ListPropertiesServerInput = {}));
class ListPropertiesSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeListPropertiesResponse;
        this.deserialize = Aws_restJson1_1.deserializeListPropertiesRequest;
    }
...
exports.ListPropertiesSerializer = ListPropertiesSerializer;
const getListPropertiesHandler = (operation) => {
    ...
    return new ListPropertiesHandler(operation, mux, new ListPropertiesSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getListPropertiesHandler = getListPropertiesHandler;
...
exports.ListPropertiesHandler = ListPropertiesHandler;
