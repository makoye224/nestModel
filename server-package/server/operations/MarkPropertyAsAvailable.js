...
exports.MarkPropertyAsAvailableHandler = exports.getMarkPropertyAsAvailableHandler = exports.MarkPropertyAsAvailableSerializer = exports.MarkPropertyAsAvailableServerInput = void 0;
...
var MarkPropertyAsAvailableServerInput;
(function (MarkPropertyAsAvailableServerInput) {
    /**
     * @internal
     */
    MarkPropertyAsAvailableServerInput.validate = models_0_1.MarkPropertyAsAvailableRequest.validate;
})(MarkPropertyAsAvailableServerInput || (exports.MarkPropertyAsAvailableServerInput = MarkPropertyAsAvailableServerInput = {}));
class MarkPropertyAsAvailableSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeMarkPropertyAsAvailableResponse;
        this.deserialize = Aws_restJson1_1.deserializeMarkPropertyAsAvailableRequest;
    }
    isOperationError(error) {
        const names = ["ValidationException", "RentalValidationException", "PropertyNotFoundException", "UnauthorizedException", "InternalServerError"];
    ...
    serializeError(error, ctx) {
        switch (error.name) {
            ...
            case "PropertyNotFoundException": {
                return (0, Aws_restJson1_1.serializePropertyNotFoundExceptionError)(error, ctx);
            }
...
exports.MarkPropertyAsAvailableSerializer = MarkPropertyAsAvailableSerializer;
const getMarkPropertyAsAvailableHandler = (operation) => {
    ...
    return new MarkPropertyAsAvailableHandler(operation, mux, new MarkPropertyAsAvailableSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getMarkPropertyAsAvailableHandler = getMarkPropertyAsAvailableHandler;
...
class MarkPropertyAsAvailableHandler {
    /**
...
exports.MarkPropertyAsAvailableHandler = MarkPropertyAsAvailableHandler;
