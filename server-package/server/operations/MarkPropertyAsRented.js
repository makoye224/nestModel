...
exports.MarkPropertyAsRentedHandler = exports.getMarkPropertyAsRentedHandler = exports.MarkPropertyAsRentedSerializer = exports.MarkPropertyAsRentedServerInput = void 0;
...
var MarkPropertyAsRentedServerInput;
(function (MarkPropertyAsRentedServerInput) {
    /**
     * @internal
     */
    MarkPropertyAsRentedServerInput.validate = models_0_1.MarkPropertyAsRentedRequest.validate;
})(MarkPropertyAsRentedServerInput || (exports.MarkPropertyAsRentedServerInput = MarkPropertyAsRentedServerInput = {}));
class MarkPropertyAsRentedSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeMarkPropertyAsRentedResponse;
        this.deserialize = Aws_restJson1_1.deserializeMarkPropertyAsRentedRequest;
    }
...
exports.MarkPropertyAsRentedSerializer = MarkPropertyAsRentedSerializer;
const getMarkPropertyAsRentedHandler = (operation) => {
    ...
    return new MarkPropertyAsRentedHandler(operation, mux, new MarkPropertyAsRentedSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getMarkPropertyAsRentedHandler = getMarkPropertyAsRentedHandler;
...
class MarkPropertyAsRentedHandler {
    /**
...
exports.MarkPropertyAsRentedHandler = MarkPropertyAsRentedHandler;
