...
exports.RemovePropertyManagerHandler = exports.getRemovePropertyManagerHandler = exports.RemovePropertyManagerSerializer = exports.RemovePropertyManagerServerInput = void 0;
...
var RemovePropertyManagerServerInput;
(function (RemovePropertyManagerServerInput) {
    /**
     * @internal
     */
    RemovePropertyManagerServerInput.validate = models_0_1.RemovePropertyManagerRequest.validate;
})(RemovePropertyManagerServerInput || (exports.RemovePropertyManagerServerInput = RemovePropertyManagerServerInput = {}));
class RemovePropertyManagerSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeRemovePropertyManagerResponse;
        this.deserialize = Aws_restJson1_1.deserializeRemovePropertyManagerRequest;
    }
...
exports.RemovePropertyManagerSerializer = RemovePropertyManagerSerializer;
const getRemovePropertyManagerHandler = (operation) => {
    ...
    return new RemovePropertyManagerHandler(operation, mux, new RemovePropertyManagerSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getRemovePropertyManagerHandler = getRemovePropertyManagerHandler;
...
class RemovePropertyManagerHandler {
    /**
...
exports.RemovePropertyManagerHandler = RemovePropertyManagerHandler;
