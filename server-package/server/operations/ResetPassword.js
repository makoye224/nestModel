...
exports.ResetPasswordHandler = exports.getResetPasswordHandler = exports.ResetPasswordSerializer = exports.ResetPasswordServerInput = void 0;
...
var ResetPasswordServerInput;
(function (ResetPasswordServerInput) {
    /**
     * @internal
     */
    ResetPasswordServerInput.validate = models_0_1.ResetPasswordInput.validate;
})(ResetPasswordServerInput || (exports.ResetPasswordServerInput = ResetPasswordServerInput = {}));
class ResetPasswordSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeResetPasswordResponse;
        this.deserialize = Aws_restJson1_1.deserializeResetPasswordRequest;
    }
...
exports.ResetPasswordSerializer = ResetPasswordSerializer;
const getResetPasswordHandler = (operation) => {
    ...
    return new ResetPasswordHandler(operation, mux, new ResetPasswordSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
