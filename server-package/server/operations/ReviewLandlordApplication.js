...
exports.ReviewLandlordApplicationHandler = exports.getReviewLandlordApplicationHandler = exports.ReviewLandlordApplicationSerializer = exports.ReviewLandlordApplicationServerInput = void 0;
...
var ReviewLandlordApplicationServerInput;
(function (ReviewLandlordApplicationServerInput) {
    /**
     * @internal
     */
    ReviewLandlordApplicationServerInput.validate = models_0_1.ReviewApplicationRequest.validate;
})(ReviewLandlordApplicationServerInput || (exports.ReviewLandlordApplicationServerInput = ReviewLandlordApplicationServerInput = {}));
class ReviewLandlordApplicationSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeReviewLandlordApplicationResponse;
        this.deserialize = Aws_restJson1_1.deserializeReviewLandlordApplicationRequest;
    }
...
exports.ReviewLandlordApplicationSerializer = ReviewLandlordApplicationSerializer;
const getReviewLandlordApplicationHandler = (operation) => {
    ...
    return new ReviewLandlordApplicationHandler(operation, mux, new ReviewLandlordApplicationSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getReviewLandlordApplicationHandler = getReviewLandlordApplicationHandler;
...
class ReviewLandlordApplicationHandler {
    /**
...
exports.ReviewLandlordApplicationHandler = ReviewLandlordApplicationHandler;
