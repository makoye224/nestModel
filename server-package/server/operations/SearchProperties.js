...
exports.SearchPropertiesHandler = exports.getSearchPropertiesHandler = exports.SearchPropertiesSerializer = exports.SearchPropertiesServerInput = void 0;
...
var SearchPropertiesServerInput;
(function (SearchPropertiesServerInput) {
    /**
     * @internal
     */
    SearchPropertiesServerInput.validate = models_0_1.SearchPropertiesRequest.validate;
})(SearchPropertiesServerInput || (exports.SearchPropertiesServerInput = SearchPropertiesServerInput = {}));
class SearchPropertiesSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeSearchPropertiesResponse;
        this.deserialize = Aws_restJson1_1.deserializeSearchPropertiesRequest;
    }
...
exports.SearchPropertiesSerializer = SearchPropertiesSerializer;
const getSearchPropertiesHandler = (operation) => {
    ...
    return new SearchPropertiesHandler(operation, mux, new SearchPropertiesSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getSearchPropertiesHandler = getSearchPropertiesHandler;
