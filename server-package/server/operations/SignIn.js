...
exports.SignInHandler = exports.getSignInHandler = exports.SignInSerializer = exports.SignInServerInput = void 0;
...
var SignInServerInput;
(function (SignInServerInput) {
    /**
     * @internal
     */
    SignInServerInput.validate = models_0_1.SignInInput.validate;
})(SignInServerInput || (exports.SignInServerInput = SignInServerInput = {}));
class SignInSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeSignInResponse;
        this.deserialize = Aws_restJson1_1.deserializeSignInRequest;
    }
...
exports.SignInSerializer = SignInSerializer;
const getSignInHandler = (operation) => {
    ...
    return new SignInHandler(operation, mux, new SignInSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
