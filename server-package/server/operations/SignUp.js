...
exports.SignUpHandler = exports.getSignUpHandler = exports.SignUpSerializer = exports.SignUpServerInput = void 0;
...
var SignUpServerInput;
(function (SignUpServerInput) {
    /**
     * @internal
     */
    SignUpServerInput.validate = models_0_1.SignUpInput.validate;
})(SignUpServerInput || (exports.SignUpServerInput = SignUpServerInput = {}));
class SignUpSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeSignUpResponse;
        this.deserialize = Aws_restJson1_1.deserializeSignUpRequest;
    }
...
exports.SignUpSerializer = SignUpSerializer;
const getSignUpHandler = (operation) => {
    ...
    return new SignUpHandler(operation, mux, new SignUpSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getSignUpHandler = getSignUpHandler;
