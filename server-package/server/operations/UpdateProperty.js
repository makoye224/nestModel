...
exports.UpdatePropertyHandler = exports.getUpdatePropertyHandler = exports.UpdatePropertySerializer = exports.UpdatePropertyServerInput = void 0;
...
var UpdatePropertyServerInput;
(function (UpdatePropertyServerInput) {
    /**
     * @internal
     */
    UpdatePropertyServerInput.validate = models_0_1.UpdatePropertyRequest.validate;
})(UpdatePropertyServerInput || (exports.UpdatePropertyServerInput = UpdatePropertyServerInput = {}));
class UpdatePropertySerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeUpdatePropertyResponse;
        this.deserialize = Aws_restJson1_1.deserializeUpdatePropertyRequest;
    }
    isOperationError(error) {
        const names = ["ValidationException", "PropertyNotFoundException", "RentalValidationException", "UnauthorizedException", "InternalServerError"];
...
exports.UpdatePropertySerializer = UpdatePropertySerializer;
const getUpdatePropertyHandler = (operation) => {
    ...
    return new UpdatePropertyHandler(operation, mux, new UpdatePropertySerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getUpdatePropertyHandler = getUpdatePropertyHandler;
