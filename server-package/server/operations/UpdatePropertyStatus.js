...
exports.UpdatePropertyStatusHandler = exports.getUpdatePropertyStatusHandler = exports.UpdatePropertyStatusSerializer = exports.UpdatePropertyStatusServerInput = void 0;
...
var UpdatePropertyStatusServerInput;
(function (UpdatePropertyStatusServerInput) {
    /**
     * @internal
     */
    UpdatePropertyStatusServerInput.validate = models_0_1.UpdatePropertyStatusRequest.validate;
})(UpdatePropertyStatusServerInput || (exports.UpdatePropertyStatusServerInput = UpdatePropertyStatusServerInput = {}));
class UpdatePropertyStatusSerializer {
    constructor() {
        this.serialize = Aws_restJson1_1.serializeUpdatePropertyStatusResponse;
        this.deserialize = Aws_restJson1_1.deserializeUpdatePropertyStatusRequest;
    }
...
exports.UpdatePropertyStatusSerializer = UpdatePropertyStatusSerializer;
const getUpdatePropertyStatusHandler = (operation) => {
    ...
    return new UpdatePropertyStatusHandler(operation, mux, new UpdatePropertyStatusSerializer(), Aws_restJson1_1.serializeFrameworkException, customizer);
};
exports.getUpdatePropertyStatusHandler = getUpdatePropertyStatusHandler;
...
class UpdatePropertyStatusHandler {
    /**
...
exports.UpdatePropertyStatusHandler = UpdatePropertyStatusHandler;
