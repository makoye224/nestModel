...
export namespace UpdateUserServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof UpdateUserRequest.validate>[0]) => __ValidationFailure[] = UpdateUserRequest.validate;
}
...
export class UpdateUserSerializer implements __OperationSerializer<RentalPlatformService<any>, "UpdateUser", UpdateUserErrors> {
  ...
  isOperationError(error: any): error is UpdateUserErrors {
    const names: UpdateUserErrors['name'][] = ["ValidationException", "RentalValidationException", "UnauthorizedException", "InternalServerError"];
...
export const getUpdateUserHandler = <Context>(operation: __Operation<UpdateUserServerInput, UpdateUserServerOutput, Context>): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  const mux = new httpbinding.HttpBindingMux<"RentalPlatform", "UpdateUser">([
...
export class UpdateUserHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly mux: __Mux<"RentalPlatform", "UpdateUser">;
  private readonly serializer: __OperationSerializer<RentalPlatformService<Context>, "UpdateUser", UpdateUserErrors>;
  ...
  constructor(
    ...
    mux: __Mux<"RentalPlatform", "UpdateUser">,
    serializer: __OperationSerializer<RentalPlatformService<Context>, "UpdateUser", UpdateUserErrors>,
    serializeFrameworkException: (e: __SmithyFrameworkException, ctx: __ServerSerdeContext) => Promise<__HttpResponse>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log('Received a request that did not match com.nest.rental#RentalPlatform.UpdateUser. This indicates a misconfiguration.');
